...
| 6 | - Lập trình các thành phần giao diện Frontend ban đầu cho Smart Docs AI <br>&emsp;+ Khởi tạo dự án bằng ReactJS, làm các thành phần giao diện khung theo Wireframe đã thống nhất <br> - Đồng bộ mã nguồn lên kho lưu trữ GitHub của nhóm <br>&emsp;+ Khởi tạo kho lưu trữ chung, thống nhất quy tắc quản lý nhánh (mỗi thành viên một nhánh riêng, tạo Pull Request để rà soát trước khi hợp nhất vào nhánh chính) | 26/06/2026 | 26/06/2026 | Kho lưu trữ GitHub dự án nhóm |
