...
| --- | --- | --- | --- | --- |
| 2-3 | - Tối ưu lại giao diện Frontend của Smart Docs AI: tách lại các thành phần cho gọn hơn, thống nhất bảng màu/khoảng cách bằng Tailwind để dễ mở rộng <br> - Nghiên cứu Amazon S3 (bucket/object, static website hosting, quản lý truy cập công khai); so sánh S3 hosting (HTTP) với S3 + CloudFront (HTTPS, cache toàn cầu) — chọn CloudFront vì cần HTTPS cho OAuth callback của Cognito <br> - Thực hành: kích hoạt CloudFront trước website tĩnh — tạo distribution trỏ về S3 bucket, cấu hình Origin Access Control (OAC) chỉ cho truy cập qua CloudFront | 29/06/2026 | 30/06/2026 | [Hướng dẫn Amazon S3](https://000057.awsstudygroup.com/vi/) |
| 4 | - Tìm hiểu Amazon RDS & Aurora <br>&emsp;+ So sánh RDS (managed engine truyền thống) với Aurora (hiệu năng cao hơn, tự scale storage) <br>&emsp;+ Nhận thấy dữ liệu dự án thiên dạng key-value — cân nhắc dùng DynamoDB thay vì RDS khi thiết kế backend thật <br> - Đọc tài liệu về triển khai, backup, restore RDS — nắm cơ chế automated backup + snapshot thủ công, làm nền so sánh với DynamoDB sau này | 01/07/2026 | 01/07/2026 | [Hướng dẫn Amazon RDS](https://000005.awsstudygroup.com/vi/) |
| 5 | - Tìm hiểu EC2 Auto Scaling (Auto Scaling Group, Launch Template, ELB, Target Group): scale theo CloudWatch metric (CPU vượt ngưỡng → tự thêm instance), ELB phân phối traffic tới các instance healthy <br> - Tổng quan EFS/FSx/Lightsail: EFS phù hợp khi nhiều EC2/container cùng đọc-ghi 1 file system chung; cuối cùng nhóm vẫn chọn S3 vì rẻ và đã quen | 02/07/2026 | 02/07/2026 | [EC2 Auto Scaling](https://000006.awsstudygroup.com/vi/) |
