...
* Khắc phục triệt để lỗi rò rỉ dữ liệu giữa các người dùng (multi-tenancy): tách riêng rõ ràng dữ liệu lưu trữ theo từng người dùng, đồng thời khắc phục lỗi phiên đăng nhập bị lẫn giữa các tab trình duyệt.
