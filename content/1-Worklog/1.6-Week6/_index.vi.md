...
| 3 | - Đăng Blog 1 (EventBridge Scheduler), Blog 2 (Cold start), Blog 3 (Lambda Tenant Isolation) lên nhóm Facebook AWS Study Group <br>&emsp;+ Rút gọn lại nội dung từ bản đầy đủ trong Workshop report thành bản Facebook (bỏ bảng, bỏ hình, thêm phần "vì sao mình chọn X thay vì Y" để tránh bị hỏi ngược) <br>&emsp;+ Đăng lần lượt từng bài, theo dõi phản hồi/bình luận trong nhóm | 28/07/2026 | 28/07/2026 | <https://www.facebook.com/groups/awsstudygroupfcj> |
