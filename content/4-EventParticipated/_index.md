...
| **Role** | Attendee |
| **Content** | An informal cloud-architect meetup with 4 speaker sessions; the ones covered in detail here are an AWS Security Agent showcase and practical AWS certification exam tips. |
| **Outcome** | Added KMS encryption for DynamoDB and a pytest gate in the CI/CD pipeline for my project, directly inspired by the security discussion. |
